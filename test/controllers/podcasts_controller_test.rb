...
class PodcastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create podcast" do
    assert_difference('Podcast.count') do
      post podcasts_url, params: { podcast: { max_count: @podcast.max_count, order_by: @podcast.order_by, query: @podcast.query, title: @podcast.title } }
    end
  ...
  test "should update podcast" do
    patch podcast_url(@podcast), params: { podcast: { max_count: @podcast.max_count, order_by: @podcast.order_by, query: @podcast.query, title: @podcast.title } }
